testLSAE MATLAB Python Package
...
A. Change to the directory that contains the file setup.py and the subdirectory testLSAE. 
...
3. Using the testLSAE Package

The testLSAE package is on your Python path. To import it into a Python script or 
session, execute:
