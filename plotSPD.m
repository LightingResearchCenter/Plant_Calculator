...
xlabel(SPDaxes,'Wavelength (nm)','FontSize',9,'FontWeight','Bold')
ylabel(SPDaxes,'Relative Spectrum (Arbitrary Units)','FontSize',9,'FontWeight','Bold')
SPDaxes.YGrid = 'On';
text(SPDaxes,400,.95,sprintf('(Absolute multiplier=%0.2f W/nm)',max(Spectrum(:,2))),'FontSize',9);
if numel(varargin)==1
